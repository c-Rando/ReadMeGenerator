...
function renderLicenseSection(license) { 
  if (license == "mit" || "MIT") { //1
    return `[![License](https://img.shields.io/badge/License-${license}-yellow.svg)](https://opensource.org/licenses/${license})`;
  } else {
    return "";
  }
  if (license == "apache" || "APACHE" ||"Apache" ) { //2
    return `[![License](https://img.shields.io/badge/License-${license}-yellow.svg)](https://opensource.org/licenses/${license})`;
  } else {
    return "";
  }
  if (license == "boost" || "Boost" || "BOOST" ) { //3
    return `[![License](https://img.shields.io/badge/License-${license}%201.0-lightblue.svg)](https://opensource.org/licenses/${license}-2.0)`;
  } else {
    return "";
  }
  if (license == "creativecommons" || "creative commons" || "Creativecommons" || "Creative commons" || "creativeCommons"|| "creative Commons" || "CREATIVE COMMONS" || "CREATIVECOMMONS") { //4
    return `[![License: CC0-1.0](https://licensebuttons.net/l/zero/1.0/80x15.png)](http://creativecommons.org/publicdomain/zero/1.0/)`;
  } else {
    return "";
  }
  if (license == "eclipse" || "Eclipse" || "ECLIPSE") { //5
